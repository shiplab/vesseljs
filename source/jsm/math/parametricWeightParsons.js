...
export function parametricWeightHull( K, L, B, T, D, CB, Fn ) {
...
export function parametricWeightDeadweight( SFR, MCR, speed, person, day ) {
...
export function parametricWeightMachinery( MCR, hdb, Der, B, T, L, test ) {
...
export function parametricWeightOutfit( Co, LBP, D ) {
