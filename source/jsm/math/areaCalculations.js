...
export function steiner( I, A, sourceAxis, targetAxis ) {
...
export function trapezoidCalculation( xbase0, xbase1, xtop0, xtop1, ybase, ytop ) {
...
export function combineAreas( array ) {
...
export function sectionCalculation( { xs, ymins, ymaxs } ) {
...
export function bilinearArea( x1, x2, y1, y2, z11, z12, z21, z22, segs = 5 ) {
...
*/
export function elementArea( v1, v2, v3, v4 ) {
...
export function signedTriangleArea( v1, v2, v3 ) {
