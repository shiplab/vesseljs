...
This section marks the milestone aimed to introduce how the compartments, tanks and equipment can be described using the library vessel.js, giving as result the Gunnerus 3D virtual representation. The Gunnerus JSON description can be imported remotely using D3:
`
)}
...
md`
The JSON element can be used as explained in the previous sections:
`
)}
...
function* _6(THREE,width,ship,invalidation,ship3D)
{
...
md `
<p style="text-align: center;font-size: 25px;"> [<< Previous](../section-2-4/index.html) || <a href="#top">Top</a> || [Next >>](../section-2-6/index.html?collection=@ferrari212/from-hull-to-simulation) </p> 
`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["THREE","width","ship","invalidation","ship3D"], _6);
